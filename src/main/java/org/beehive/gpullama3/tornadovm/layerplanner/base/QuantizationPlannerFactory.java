...
import org.beehive.gpullama3.tornadovm.layerplanner.model.fp16.Gemma3FP16LayerPlanner;
...
import org.beehive.gpullama3.tornadovm.layerplanner.model.q8_0.Gemma3Q8_0LayerPlanner;
...
public class QuantizationPlannerFactory {
    ...
    private static GenericLayerPlanner createFP16Planner(State state, Model model) {
        return switch (model.getModelType()) {
            ...
            case GEMMA_3 -> new Gemma3FP16LayerPlanner((Gemma3State) state, model);
    ...
    private static GenericLayerPlanner createQ8_0Planner(State state, Model model) {
        return switch (model.getModelType()) {
            ...
            case GEMMA_3 -> new Gemma3Q8_0LayerPlanner((Gemma3State) state, model);
